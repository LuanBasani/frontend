...
//forEach ( para cada elemento do array) => s

arrayMisto.forEach(function (arrayMisto) {
...
// indexOf
console.log(arrayNumerico.indexOf(5));
console.log(arrayNumerico.indexOf(10));

// remover elemento de uma opsição
// splice 
arrayMisto.splice(2,1); // remove o elemento da posição do index 2 uma vez
console.log(arrayMisto);
